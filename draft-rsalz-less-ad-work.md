...
docname: draft-rsalz-less-ad-work
...
the job descriptions used by the NomCom over the years.
...
At the same time (2018), the descriprion introduced text to say:

> Enough time must be allocated to manage approximately 10 to 15 working
> groups, to read on the order of 500 pages of internet-drafts every two
> weeks
...
> sodastream folks?
> **DISCUSSION** From the datatracker? The Secretariat have monitored
> the pagecount arriving on the IES agendas for at least five years: they
> may have access to this historic data.
...
they hope that some of their employees' time will be available for work
...
> **DISCUSSION** It's interesting, cos a number of academics have been
...
> **DISCUSSION** I'm not clear of this idea. Is it based on a 
...
A new AD should not be able to add work on authors, or for them.
